            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcroumb-title text-center">
                        ...
                        <h6><a href="index.blade.php">{{ trans('site.home') }}</a> / {{ trans('site.products') }}</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="project-area gray-bg section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <div class="mb-4 mt-2">
                        <span class="fw-bold me-2" style="color: #016A41;">Category:</span><span
                            style="color: #777;">{{ app()->getLocale() == 'ar' ? $data['product']->subCategory->category->title_ar : $data['product']->subCategory->category->title_en }}</span>
                    </div>
                    <hr>
        ...
        <div class="container">
            <div class="title mt-3 mb-4">
                <h2>{{ trans('site.related_products') }}</h2>
            </div>
            <div class="row">
